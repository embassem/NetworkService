...
public  func reversedPrintWithSeparator(_ separator: String, terminator: String, items: Any...) {
    print("\n==============================================================================================================================\n")
    for item in items {
...
public final class NetworkLoggerPluginSeparator: PluginType {
    ...
    public init(verbose: Bool = false, cURL: Bool = false, output: ((_ separator: String, _ terminator: String, _ items: Any...) -> Void)? = nil, requestDataFormatter: ((Data) -> (String))? = nil, responseDataFormatter: ((Data) -> (Data))? = nil) {
        ...
        self.output = output ?? reversedPrintWithSeparator
...
fileprivate extension NetworkLoggerPluginSeparator {
